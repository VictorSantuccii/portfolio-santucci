...
const projects = [
  ...
  },
  {
    ...
    description:
      "Transforme frases do português em fórmulas lógicas e vice-versa com nossa tecnologia de ponta. Uma ponte inteligente entre linguagem natural e lógica proposicional.",
    technologies: [
      "Next.js",
      "Supabase",
      "OAuth",
  ...
  },
  {
    ...
    image: "/ecocash.png",
    description:
      "Aplicação web para gestão financeira pessoal com autenticação e cloud sync",
    technologies: [
      "Next.js",
      "Firebase",
      "Tailwind CSS",
...
export default function Home() {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setCurrentTitle((prev) => (prev === titles[0] ? titles[1] : titles[0]));
    }, 5000);
    ...
    <div className="min-h-screen bg-[#000000] text-white">
      ...
      >
        ...
        <motion.a
          ...
          className="text-2xl text-white hover:text-[#1DB954] transition-all duration-300"
      ...
      {!isMenuOpen && (
        ...
        >
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-xl text-white hover:text-[#1DB954] transition-colors duration-300"
          >
            <AiFillGithub />
          </a>
          <a
              ...
              {[
                {
                  ...
                  title: "Código Limpo",
                  description:
                    "Comprometido com princípios SOLID e Clean Architecture. Foco em legibilidade, manutenibilidade e boas práticas de desenvolvimento.",
                  color: "#DEE0E3",
                },
                {
                  ...
                  description:
                    "Habilidade analítica para decompor desafios complexos. Abordagem sistemática com foco em soluções eficientes e escaláveis.",
                  color: "#F7F06D",
                },
                {
                  ...
                  description:
                    "Expertise em identificar gargalos e implementar melhorias. Domínio de técnicas de caching e algoritmos eficientes.",
                  color: "#00E0FF",
                },
                {
                  ...
                  description:
                    "Comunicação clara e colaboração eficaz. Experiência em metodologias ágeis e integração contínua com times multidisciplinares.",
                  color: "#FF00FF",
                },
              ].map((skill, index) => (
                <motion.div
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <h3
                      className="text-xl font-semibold mb-2 font-geist-mono"
        ...
        <div className="max-w-2xl font-jura mx-auto px-4 relative z-10">
          ...
          >
            {[
              {
                field: "nome",
                icon: <FiUser className="text-[#1DB954] mr-2" />,
              },
              {
                field: "email",
                icon: <FiMail className="text-[#1DB954] mr-2" />,
              },
              {
                field: "message",
                icon: <FiMessageCircle className="text-[#1DB954] mr-2" />,
              },
